...
| **UPDATE** | Atualizar telefone do aluno |
...
| **SQLite3** | Banco de dados (sem necessidade de instalação)
...
![Ver alunos por curso](prints/ver_alunos_por_cursos.jpeg)
